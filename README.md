...
| ------------------------------------- | ---------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| ButtonToButtonConverter               | Button: Bool                                                           | Bool   |                                                                                                         |                                                                                    |      
| InverseButtonToButtonConverter        | Button: Bool                                                           | Bool   |                                                                                                         |                                                                                    |             
| AndButtonToButtonConverter            | ButtonX: Bool*                                                         | Bool   |                                                                                                         |                                                                                    |         
| OrButtonToButtonConverter             | ButtonX: Bool*                                                         | Bool   |                                                                                                         |                                                                                    |        
| StickToStickConverter                 | Stick: Vec2                                                            | Vec2   |                                                                                                         |                                                                                    |    
| ButtonAndStickToStickConverter        | Button: Bool <br> Stick: Vec2                                          | Vec2   |                                                                                                         |                                                                                    |             
| TriggerToTriggerConverter             | Trigger: Float                                                         | Float  |                                                                                                         |                                                                                    |        
| ButtonAndTriggerToTriggerConverter    | Button: Bool <br> Trigger: Float                                       | Float  |                                                                                                         |                                                                                    |                 
| TiltToStickConverter                  | Accelerometer: Vec3 <br> Gyro: Vec3                                    | Vec2   | Sensitivity: Float <br> Deadzone: Float <br> Gamma: Float                                               |                                                                                    |   
| ButtonAndTiltToStickConverter         | Button: Bool <br> Stick: Vec2                                          | Vec2   | ***TiltToStickConverter\****                                                                            |                                                                                    |            
| TiltAndStickToStickConverter          | Accelerometer: Vec3 <br> Gyro: Vec3 <br> Stick: Vec2                   | Vec2   | ***TiltToStickConverter\**** <br> AlphaX: Float <br> AlphaY: Float <br> BetaX: Float <br> BetaY: Float  |                                                                                    |           
| ButtonAndTiltAndStickToStickConverter | Button: Bool <br> Accelerometer: Vec3 <br> Gyro: Vec3 <br> Stick: Vec2 | Vec2   | ***TiltAndStickToStickConverter\****                                                                    |                                                                                    |                    
| GyroToStickConverter                  | Gyro: Vec3                                                             | Vec2   | GammaX: Float <br> GammaY: Float <br> EpsilonX: Float <br> EpsilonY                                     |                                                                                    |   
| ButtonAndGyroToStickConverter         | Button: Bool <br> Gyro: Vec3                                           | Vec2   | ***GyroToStickConverter\****                                                                            |                                                                                    |            
| GyroAndStickToStickConverter          | Gyro: Vec3 <br> Stick: Vec2                                            | Vec2   | ***GyroToStickConverter\**** <br> AlphaX: Float <br> AlphaY: Float <br> BetaX: Float <br> BetaY: Float  |                                                                                    |           
| ButtonAndGyroAndStickToStickConverter | Button: Bool <br> Gyro: Vec3 <br> Stick: Vec2                          | Vec2   | ***GyroAndStickToStickConverter\****                                                                    |                                                                                    |                    

**Arguments**
Sensitivity: Linear sensitivity for tilt to stick conversions. Default: 1,0. Range: 0,0 - infinity.
Deadzone: Circular deadzone for tilt to stick conversion. Default 0,0. Range 0,0 - 1,0.
Alpha/Beta: Coefficients for adding two inputs. I.e. Input1 * Alpha + Input2 * Beta. Default 1,0. Range: -Infinity - Infinity.
Gamma: Curvature parameter for tilt and gyro conversions. I.e. Input ^ Gamma. Default 1,0. Range: 0,0 - Infinity.
